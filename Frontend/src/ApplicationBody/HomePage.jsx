...
import { priorityFilters, priorityFiltersDispatcher, userInfo } from "../ApplicationContext";
...
export default function HomePage() {
  ...
  const userInfoState = useContext(userInfo);
  ...
  return (
          <div>
            <div>{userInfoState.FirstName}</div>
